  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      <main className="max-w-[800px] mx-auto px-4 py-10 space-y-8">
        ...
        {/* Footer */}
        <footer className="w-full border-t border-border/40 pt-8 mt-16 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground font-medium">
